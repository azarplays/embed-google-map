...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="/css/bootstrap.min.css" integrity="sha512-oc9+XSs1H243/FRN9Rw62Fn8EtxjEYWHXRvjS43YtueEewbS6ObfXcJNyohjHqVKFPoXXUxwc+q1K7Dee6vv9g==" crossorigin="anonymous" />
    <link rel="stylesheet" href="/css/bootstrap-slider.min.css" integrity="sha512-3q8fi8M0VS+X/3n64Ndpp6Bit7oXSiyCnzmlx6IDBLGlY5euFySyJ46RUlqIVs0DPCGOypqP8IRk/EyPvU28mQ==" crossorigin="anonymous" />
    <!-- Custom CSS -->
    ...
    <script type="application/ld+json">
      [{
        ...
        "potentialAction": {
          "@type": "SearchAction",
          "target": "/?addr={search_term_string}",
    ...
    <script>
      ...
      })(window, document, 'script', 'dataLayer', 'GTM-NFMC75P');
    </script>
  ...
  <body>
    ...
    <noscript>
      <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NFMC75P" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
                ...
                <div class="w-100 p-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div style="position:absolute;left: 55px;top: 27px;font-weight: 500;font-size: 20px;">Embed Google Map <br>(No API Needed) </div>
                      <div id="locationConf">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <div class="input-group-append">
                                <span class="input-group-text" id="addon1">px</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <div class="input-group-append">
                                <span class="input-group-text" id="addon2">px</span>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="w-100 p-3 overflow-auto">
                  <div id="map-container">
                    ...
                    <div style="height:0;overflow:hidden;">
                      ...
                      <a href="/">Embed Google Map</a>
                    </div>
                  </div>
                  <div id="directionNote" style="display:none;padding-top:15px;">
                    <p>
                      <span class="text-danger font-weight-bold">Note:</span> Adjust <span class="font-weight-bold">Zoom Distance</span> if route is not visible
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <p style="text-align: center;">
          <img src="embed-google-map.png" alt="embed google map" width="50%">
        </p>
        <p style="text-align: justify;">
          <br>
        </p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <div class="copyright">2022 &copy; <a href="/">Embed Google Maps</a>
            </div>
          </div>
        </div>
      </div>
